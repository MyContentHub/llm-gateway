...
import { runMigrations } from "../../../gateway/src/db/migrations.js";
import { KeyStore } from "../../../gateway/src/db/keys.js";
import type { RateLimits } from "../../../gateway/src/db/keys.js";
import { AuditStore } from "../../../gateway/src/db/audit-store.js";
import type { AuditLogEntry } from "../../../gateway/src/db/audit-store.js";
import { RateLimiter, createRateLimitMiddleware, createRateLimitResponseHook } from "../../../gateway/src/middleware/rate-limit.js";
import { createAuthMiddleware } from "../../../gateway/src/middleware/auth.js";
import { createAuditLogger } from "../../../gateway/src/audit/logger.js";
import { setupMetrics } from "../../../gateway/src/audit/metrics.js";
import { chatCompletionsPlugin } from "../../../gateway/src/routes/v1/chat-completions.js";
import { embeddingsPlugin } from "../../../gateway/src/routes/v1/embeddings.js";
import { modelsPlugin } from "../../../gateway/src/routes/v1/models.js";
import { openapiPlugin } from "../../../gateway/src/plugins/openapi.js";
import { adminKeysPlugin } from "../../../gateway/src/routes/admin/keys.js";
import { adminAuditPlugin } from "../../../gateway/src/routes/admin/audit.js";
import { adminConfigPlugin } from "../../../gateway/src/routes/admin/config.js";
import serveAdmin from "../../../gateway/src/plugins/serve-admin.js";
import { KeyHealthTracker } from "../../../gateway/src/proxy/health-tracker.js";
import { createMockUpstream, getServerUrl } from "../../../gateway/tests/helpers/mock-upstream.js";
import type { AppConfig } from "../../../gateway/src/config/index.js";
...
export async function startE2EServer(): Promise<E2EServerResult> {
  ...
  const migrationsDir = resolve(import.meta.dirname, "../../../gateway/migrations");
